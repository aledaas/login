...
(function ($) {
    ...
    $.fn.fileinput.defaults = {
        ...
        maxFileSize: 0,
        maxFileCount: 0,
        msgSizeTooLarge: 'Archivo "{name}" (<b>{size} KB</b>) excede el maximo permitido de <b>{maxSize} KB</b>.',
        msgFilesTooMany: 'Number of files selected for upload <b>({n})</b> exceeds maximum allowed limit of <b>{m}</b>. Please retry your upload!',
        msgFileNotFound: 'File "{name}" not found!',
        msgFileNotReadable: 'Archivo "{name}" es no leible.',
        msgFilePreviewAborted: 'File preview aborted for "{name}".',
        msgFilePreviewError: 'Un error ha ocurrido al leer el archivo "{name}".',
        msgInvalidFileType: 'Invalido tipo para el archivo "{name}". Solo "{types}" arhivos son soportados.',
        msgInvalidFileExtension: 'Invalida extension para el archivo "{name}". Solo las extensiones de los archivos "{extensions}" son soportados.',
        msgValidationError: '<span class="text-danger"><i class="glyphicon glyphicon-exclamation-sign"></i> Error al Seleccionar Archivo</span>',
